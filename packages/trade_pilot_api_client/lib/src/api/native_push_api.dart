...
class NativePushApi {
  ...
  const NativePushApi(this._dio, this._serializers);
  ...
  Future<Response<MessageResponse>> registerNativePushDevice({
    ...
    final _path = r'/native-push/register';
    ...
    try {
      const _type = FullType(NativePushRegisterBody);
      _bodyData =
          _serializers.serialize(nativePushRegisterBody, specifiedType: _type);
  ...
  Future<Response<MessageResponse>> unregisterNativePushDevice({
    ...
    final _path = r'/native-push/unregister';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(NativePushUnregisterBody);
      _bodyData = _serializers.serialize(nativePushUnregisterBody,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
