...
class TradeJournalApi {
  ...
  Future<Response<JournalSentiment>> getJournalSentiment({
    ...
    final _path = r'/journal/sentiment';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    JournalSentiment? _responseData;
    ...
    return Response<JournalSentiment>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<JournalEntryList>> listJournalEntries({
    ...
    JournalEntryList? _responseData;
    ...
    return Response<JournalEntryList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
