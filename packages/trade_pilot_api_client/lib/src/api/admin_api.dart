...
class AdminApi {
  ...
  Future<Response<BroadcastSendResult>> broadcastNotification({
    ...
    BroadcastSendResult? _responseData;
  ...
  Future<Response<AnalyticsTokenStats>> getAdminAnalyticsTokens({
    ...
    final _path = r'/admin/analytics/tokens';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AnalyticsTokenStats? _responseData;
    ...
    return Response<AnalyticsTokenStats>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AnalyticsUsageStats>> getAdminAnalyticsUsage({
    ...
    final _path = r'/admin/analytics/usage';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AnalyticsUsageStats? _responseData;
    ...
    return Response<AnalyticsUsageStats>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [to] - Only include feedback created on or before this date (ISO 8601 date, inclusive end-of-day)
  /// * [analysisId] - When set, only return feedback for the given analysis id.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<AdminFeedbackList>> getAdminFeedback({
    ...
    AdminFeedbackList? _responseData;
    ...
    return Response<AdminFeedbackList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BroadcastsList>> getBroadcasts({
    ...
    final _path = r'/admin/broadcasts';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    return Response<BroadcastsList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<OutboundClickStats>> getOutboundClickStats({
    ...
    final _path = r'/admin/outbound-clicks/stats';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    OutboundClickStats? _responseData;
