...
class PushApi {
  ...
  Future<Response<PushSubscriptionStatus>> getPushSubscriptionStatus({
    ...
    final _path = r'/push/subscription-status';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    PushSubscriptionStatus? _responseData;
    ...
    return Response<PushSubscriptionStatus>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<PushTestResult>> sendPushTest({
    ...
    return Response<PushTestResult>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<MessageResponse>> unsubscribePush({
    ...
    final _path = r'/push/unsubscribe';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
