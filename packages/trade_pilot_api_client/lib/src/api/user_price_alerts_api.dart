...
class UserPriceAlertsApi {
  ...
  Future<Response<UserPriceAlert>> createUserPriceAlert({
    ...
    final _path = r'/user-price-alerts';
    ...
    return Response<UserPriceAlert>(
      data: _responseData,
  ...
  Future<Response<UserPriceAlertList>> listUserPriceAlerts({
    ...
    UserPriceAlertList? _responseData;
    ...
    return Response<UserPriceAlertList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
