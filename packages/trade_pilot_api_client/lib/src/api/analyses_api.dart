...
class AnalysesApi {
  ...
  Future<Response<AnalysesSummary>> getAnalysesSummary({
    ...
    final _path = r'/analyses/summary';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    return Response<AnalysesSummary>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AnalysisOutcomesSummary>> getAnalysisOutcomesSummary({
    ...
    final _path = r'/analyses/outcomes-summary';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AnalysisOutcomesSummary? _responseData;
    ...
    return Response<AnalysisOutcomesSummary>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<PersonalAnalytics>> getPersonalAnalytics({
    ...
    final _path = r'/analyses/personal-analytics';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    PersonalAnalytics? _responseData;
    ...
    return Response<PersonalAnalytics>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<RecentInstruments>> getRecentInstruments({
    ...
    final _path = r'/analyses/recent-instruments';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RecentInstruments? _responseData;
  ...
  Future<Response<RefreshFundamentalsResponse>> refreshFundamentals({
    ...
    RefreshFundamentalsResponse? _responseData;
    ...
    return Response<RefreshFundamentalsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AnalysisNoteResponse>> setAnalysisNote({
    ...
    AnalysisNoteResponse? _responseData;
    ...
    return Response<AnalysisNoteResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
