...
class AuthApi {
  ...
  Future<Response<MessageResponse>> changeSecurityQuestion({
    ...
    final _path = r'/auth/security-question';
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<SecurityQuestionResponse>> getForgotPasswordQuestion({
    ...
    final _path = r'/auth/forgot-password/question';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    SecurityQuestionResponse? _responseData;
  ...
  /// Returns a [Future] containing a [Response] with a [AuthResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthResponse>> loginWithAppleNative({
    required AppleNativeLoginBody appleNativeLoginBody,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/apple/native';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(AppleNativeLoginBody);
      _bodyData =
          _serializers.serialize(appleNativeLoginBody, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [AuthResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthResponse>> loginWithGoogleNative({
    required GoogleNativeLoginBody googleNativeLoginBody,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/google/native';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(GoogleNativeLoginBody);
      _bodyData =
          _serializers.serialize(googleNativeLoginBody, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AppleReauthResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AppleReauthResponse>> reauthenticateWithApple({
    required AppleReauthBody appleReauthBody,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/reauth/apple';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(AppleReauthBody);
      _bodyData = _serializers.serialize(appleReauthBody, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
    ...
    AppleReauthResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(AppleReauthResponse),
            ) as AppleReauthResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<AppleReauthResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GoogleReauthResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GoogleReauthResponse>> reauthenticateWithGoogle({
    required GoogleReauthBody googleReauthBody,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/reauth/google';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(GoogleReauthBody);
      _bodyData =
          _serializers.serialize(googleReauthBody, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
    ...
    GoogleReauthResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(GoogleReauthResponse),
            ) as GoogleReauthResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<GoogleReauthResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<MessageResponse>> resetPassword({
    ...
    final _path = r'/auth/forgot-password/reset';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ResetTokenResponse>> verifySecurityAnswer({
    ...
    final _path = r'/auth/forgot-password/verify';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ResetTokenResponse? _responseData;
    ...
    return Response<ResetTokenResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
