...
class TradingRulesApi {
  ...
  const TradingRulesApi(this._dio, this._serializers);
  ...
  Future<Response<StandardTradingRules>> getStandardTradingRules({
    ...
    final _path = r'/trading-rules/standard';
    ...
    StandardTradingRules? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(StandardTradingRules),
            ) as StandardTradingRules;
    ...
    return Response<StandardTradingRules>(
      data: _responseData,
