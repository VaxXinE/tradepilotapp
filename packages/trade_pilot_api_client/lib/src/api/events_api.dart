...
class EventsApi {
  ...
  Future<Response<void>> recordOutboundClick({
    ...
    final _path = r'/events/outbound-click';
    ...
    try {
      const _type = FullType(OutboundClickBody);
      _bodyData =
          _serializers.serialize(outboundClickBody, specifiedType: _type);
  ...
  Future<Response<void>> trackAnalyticsEvent({
    ...
    try {
      const _type = FullType(AnalyticsEventBody);
      _bodyData =
          _serializers.serialize(analyticsEventBody, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
