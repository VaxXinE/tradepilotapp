...
class ProgressionApi {
  ...
  Future<Response<ProgressionCatalog>> getProgressionCatalog({
    ...
    final _path = r'/progression/catalog';
    ...
    ProgressionCatalog? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ProgressionCatalog),
            ) as ProgressionCatalog;
    ...
    return Response<ProgressionCatalog>(
      data: _responseData,
  ...
  Future<Response<ProgressionHistory>> getProgressionHistory({
    ...
    final _path = r'/progression/history';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ProgressionHistory? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ProgressionHistory),
            ) as ProgressionHistory;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ProgressionHistory>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ProgressionSummary>> getProgressionSummary({
    ...
    final _path = r'/progression/summary';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ProgressionSummary? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ProgressionSummary),
    ...
    return Response<ProgressionSummary>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ProgressionAward>> recordProgressionActivity({
    ...
    final _path = r'/progression/activity';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ProgressionActivityInput);
      _bodyData = _serializers.serialize(progressionActivityInput,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  Future<Response<ProgressionEvidenceSession>> startProgressionEvidence({
    ...
    final _path = r'/progression/evidence';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ProgressionEvidenceStartInput);
      _bodyData = _serializers.serialize(progressionEvidenceStartInput,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
    ...
    ProgressionEvidenceSession? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ProgressionEvidenceSession),
            ) as ProgressionEvidenceSession;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ProgressionEvidenceSession>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
