...
@BuiltValue()
abstract class GoogleNativeLoginBody
    implements Built<GoogleNativeLoginBody, GoogleNativeLoginBodyBuilder> {
  ...
  factory GoogleNativeLoginBody(
      [void updates(GoogleNativeLoginBodyBuilder b)]) = _$GoogleNativeLoginBody;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GoogleNativeLoginBodyBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GoogleNativeLoginBody> get serializer =>
      _$GoogleNativeLoginBodySerializer();
}

class _$GoogleNativeLoginBodySerializer
    implements PrimitiveSerializer<GoogleNativeLoginBody> {
  @override
  final Iterable<Type> types = const [
    GoogleNativeLoginBody,
    _$GoogleNativeLoginBody
  ];
