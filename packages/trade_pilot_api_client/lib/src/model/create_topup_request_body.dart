...
abstract class CreateTopupRequestBody
  ...
  factory CreateTopupRequestBody(
          [void updates(CreateTopupRequestBodyBuilder b)]) =
      _$CreateTopupRequestBody;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateTopupRequestBodyBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateTopupRequestBody> get serializer =>
      _$CreateTopupRequestBodySerializer();
}

class _$CreateTopupRequestBodySerializer
    implements PrimitiveSerializer<CreateTopupRequestBody> {
  @override
