...
/// * [expiresAt]
@BuiltValue()
abstract class AppleReauthResponse
    implements Built<AppleReauthResponse, AppleReauthResponseBuilder> {
  ...
  factory AppleReauthResponse([void updates(AppleReauthResponseBuilder b)]) =
      _$AppleReauthResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AppleReauthResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AppleReauthResponse> get serializer =>
      _$AppleReauthResponseSerializer();
}

class _$AppleReauthResponseSerializer
    implements PrimitiveSerializer<AppleReauthResponse> {
  @override
