...
/// * [ruleVersion]
@BuiltValue()
abstract class ProgressionBackfillResult
    implements
        Built<ProgressionBackfillResult, ProgressionBackfillResultBuilder> {
  ...
  factory ProgressionBackfillResult(
          [void updates(ProgressionBackfillResultBuilder b)]) =
      _$ProgressionBackfillResult;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProgressionBackfillResultBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProgressionBackfillResult> get serializer =>
      _$ProgressionBackfillResultSerializer();
}

class _$ProgressionBackfillResultSerializer
    implements PrimitiveSerializer<ProgressionBackfillResult> {
  @override
