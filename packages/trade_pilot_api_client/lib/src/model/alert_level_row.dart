...
/// * [cancelledAt]
@BuiltValue()
abstract class AlertLevelRow
    implements Built<AlertLevelRow, AlertLevelRowBuilder> {
  ...
  factory AlertLevelRow([void updates(AlertLevelRowBuilder b)]) =
      _$AlertLevelRow;
  ...
  static Serializer<AlertLevelRow> get serializer =>
      _$AlertLevelRowSerializer();
}
...
class AlertLevelRowLevelEnum extends EnumClass {
  ...
  static Serializer<AlertLevelRowLevelEnum> get serializer =>
      _$alertLevelRowLevelEnumSerializer;

  const AlertLevelRowLevelEnum._(String name) : super(name);

  static BuiltSet<AlertLevelRowLevelEnum> get values =>
      _$alertLevelRowLevelEnumValues;
  static AlertLevelRowLevelEnum valueOf(String name) =>
      _$alertLevelRowLevelEnumValueOf(name);
}
...
class AlertLevelRowSideEnum extends EnumClass {
  ...
  static Serializer<AlertLevelRowSideEnum> get serializer =>
      _$alertLevelRowSideEnumSerializer;

  const AlertLevelRowSideEnum._(String name) : super(name);

  static BuiltSet<AlertLevelRowSideEnum> get values =>
      _$alertLevelRowSideEnumValues;
  static AlertLevelRowSideEnum valueOf(String name) =>
      _$alertLevelRowSideEnumValueOf(name);
}

class AlertLevelRowDirectionEnum extends EnumClass {
  /// Which way price must move from the spot at arm time to fire the alert. `above` = fire when live ≥ price; `below` = fire when live ≤ price.
  @BuiltValueEnumConst(wireName: r'above')
  static const AlertLevelRowDirectionEnum above =
      _$alertLevelRowDirectionEnum_above;

  /// Which way price must move from the spot at arm time to fire the alert. `above` = fire when live ≥ price; `below` = fire when live ≤ price.
  @BuiltValueEnumConst(wireName: r'below')
  static const AlertLevelRowDirectionEnum below =
      _$alertLevelRowDirectionEnum_below;

  static Serializer<AlertLevelRowDirectionEnum> get serializer =>
      _$alertLevelRowDirectionEnumSerializer;

  const AlertLevelRowDirectionEnum._(String name) : super(name);

  static BuiltSet<AlertLevelRowDirectionEnum> get values =>
      _$alertLevelRowDirectionEnumValues;
  static AlertLevelRowDirectionEnum valueOf(String name) =>
      _$alertLevelRowDirectionEnumValueOf(name);
}
