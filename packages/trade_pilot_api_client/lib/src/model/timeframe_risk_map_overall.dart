...
/// * [reasonCode]
@BuiltValue()
abstract class TimeframeRiskMapOverall
    implements Built<TimeframeRiskMapOverall, TimeframeRiskMapOverallBuilder> {
  ...
  factory TimeframeRiskMapOverall(
          [void updates(TimeframeRiskMapOverallBuilder b)]) =
      _$TimeframeRiskMapOverall;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TimeframeRiskMapOverallBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TimeframeRiskMapOverall> get serializer =>
      _$TimeframeRiskMapOverallSerializer();
}

class _$TimeframeRiskMapOverallSerializer
    implements PrimitiveSerializer<TimeframeRiskMapOverall> {
  @override
...
class TimeframeRiskMapOverallStateEnum extends EnumClass {
  ...
  static const TimeframeRiskMapOverallStateEnum wait =
      _$timeframeRiskMapOverallStateEnum_wait;
  @BuiltValueEnumConst(wireName: r'no_recommendation')
  static const TimeframeRiskMapOverallStateEnum noRecommendation =
      _$timeframeRiskMapOverallStateEnum_noRecommendation;

  static Serializer<TimeframeRiskMapOverallStateEnum> get serializer =>
      _$timeframeRiskMapOverallStateEnumSerializer;

  const TimeframeRiskMapOverallStateEnum._(String name) : super(name);

  static BuiltSet<TimeframeRiskMapOverallStateEnum> get values =>
      _$timeframeRiskMapOverallStateEnumValues;
  static TimeframeRiskMapOverallStateEnum valueOf(String name) =>
      _$timeframeRiskMapOverallStateEnumValueOf(name);
}
