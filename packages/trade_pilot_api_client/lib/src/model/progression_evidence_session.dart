...
/// * [minimumCompleteAt]
@BuiltValue()
abstract class ProgressionEvidenceSession
    implements
        Built<ProgressionEvidenceSession, ProgressionEvidenceSessionBuilder> {
  ...
  factory ProgressionEvidenceSession(
          [void updates(ProgressionEvidenceSessionBuilder b)]) =
      _$ProgressionEvidenceSession;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProgressionEvidenceSessionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProgressionEvidenceSession> get serializer =>
      _$ProgressionEvidenceSessionSerializer();
}

class _$ProgressionEvidenceSessionSerializer
    implements PrimitiveSerializer<ProgressionEvidenceSession> {
  @override
