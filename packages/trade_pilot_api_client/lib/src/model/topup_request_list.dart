...
/// * [limit]
@BuiltValue()
abstract class TopupRequestList
    implements Built<TopupRequestList, TopupRequestListBuilder> {
  ...
  factory TopupRequestList([void updates(TopupRequestListBuilder b)]) =
      _$TopupRequestList;
  ...
  static Serializer<TopupRequestList> get serializer =>
      _$TopupRequestListSerializer();
}

class _$TopupRequestListSerializer
    implements PrimitiveSerializer<TopupRequestList> {
  @override
