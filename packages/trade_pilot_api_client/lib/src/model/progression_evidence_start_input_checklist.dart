...
/// * [timeframe]
@BuiltValue()
abstract class ProgressionEvidenceStartInputChecklist
    implements
        Built<ProgressionEvidenceStartInputChecklist,
  ...
  factory ProgressionEvidenceStartInputChecklist(
          [void updates(ProgressionEvidenceStartInputChecklistBuilder b)]) =
      _$ProgressionEvidenceStartInputChecklist;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProgressionEvidenceStartInputChecklistBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProgressionEvidenceStartInputChecklist> get serializer =>
      _$ProgressionEvidenceStartInputChecklistSerializer();
}

class _$ProgressionEvidenceStartInputChecklistSerializer
    implements PrimitiveSerializer<ProgressionEvidenceStartInputChecklist> {
  @override
