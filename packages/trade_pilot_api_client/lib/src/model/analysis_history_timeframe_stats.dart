...
/// * [timeframe]
@BuiltValue()
abstract class AnalysisHistoryTimeframeStats
    implements
        AnalysisHistoryOutcomeStats,
        Built<AnalysisHistoryTimeframeStats,
  ...
  factory AnalysisHistoryTimeframeStats(
          [void updates(AnalysisHistoryTimeframeStatsBuilder b)]) =
      _$AnalysisHistoryTimeframeStats;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AnalysisHistoryTimeframeStatsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AnalysisHistoryTimeframeStats> get serializer =>
      _$AnalysisHistoryTimeframeStatsSerializer();
}

class _$AnalysisHistoryTimeframeStatsSerializer
    implements PrimitiveSerializer<AnalysisHistoryTimeframeStats> {
  @override
