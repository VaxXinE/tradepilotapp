...
/// * [winter]
@BuiltValue()
abstract class StandardTradingRuleInstrumentTradingHours
    implements
        Built<StandardTradingRuleInstrumentTradingHours,
  ...
  factory StandardTradingRuleInstrumentTradingHours(
          [void updates(StandardTradingRuleInstrumentTradingHoursBuilder b)]) =
      _$StandardTradingRuleInstrumentTradingHours;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StandardTradingRuleInstrumentTradingHoursBuilder b) =>
      b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StandardTradingRuleInstrumentTradingHours> get serializer =>
      _$StandardTradingRuleInstrumentTradingHoursSerializer();
}

class _$StandardTradingRuleInstrumentTradingHoursSerializer
    implements PrimitiveSerializer<StandardTradingRuleInstrumentTradingHours> {
  @override
