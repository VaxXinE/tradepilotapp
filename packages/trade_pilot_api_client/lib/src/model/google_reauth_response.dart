...
/// * [expiresAt]
@BuiltValue()
abstract class GoogleReauthResponse
    implements Built<GoogleReauthResponse, GoogleReauthResponseBuilder> {
  ...
  factory GoogleReauthResponse([void updates(GoogleReauthResponseBuilder b)]) =
      _$GoogleReauthResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GoogleReauthResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GoogleReauthResponse> get serializer =>
      _$GoogleReauthResponseSerializer();
}

class _$GoogleReauthResponseSerializer
    implements PrimitiveSerializer<GoogleReauthResponse> {
  @override
