...
/// * [balance]
@BuiltValue()
abstract class CreditBalance
    implements Built<CreditBalance, CreditBalanceBuilder> {
  @BuiltValueField(wireName: r'balance')
  int get balance;

  CreditBalance._();

  factory CreditBalance([void updates(CreditBalanceBuilder b)]) =
      _$CreditBalance;
  ...
  static Serializer<CreditBalance> get serializer =>
      _$CreditBalanceSerializer();
}
