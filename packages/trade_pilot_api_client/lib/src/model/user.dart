...
/// * [themePreference]
/// * [onboardingCompleted]
/// * [hasPassword] - True when the account has a local password usable for login and for re-authentication. False for Google-only or Apple-only accounts.
/// * [createdAt]
@BuiltValue()
abstract class User implements Built<User, UserBuilder> {
  ...
  /// True when the account has a local password usable for login and for re-authentication. False for Google-only or Apple-only accounts.
