...
/// * [deliveryBy]
@BuiltValue()
abstract class StandardTradingRuleInstrument
    implements
        Built<StandardTradingRuleInstrument,
  ...
  factory StandardTradingRuleInstrument(
          [void updates(StandardTradingRuleInstrumentBuilder b)]) =
      _$StandardTradingRuleInstrument;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StandardTradingRuleInstrumentBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StandardTradingRuleInstrument> get serializer =>
      _$StandardTradingRuleInstrumentSerializer();
}

class _$StandardTradingRuleInstrumentSerializer
    implements PrimitiveSerializer<StandardTradingRuleInstrument> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.contractUnit,
      specifiedType:
          const FullType(StandardTradingRuleInstrumentContractUnitEnum),
    );
    yield r'tradingDays';
    yield serializers.serialize(
      object.tradingDays,
    ...
    yield object.facilityFeeUsdPerLotPerSide == null
        ? null
      ...
      switch (key) {
        case r'code':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(StandardTradingRuleInstrumentCodeEnum),
        ...
        case r'tradingHours':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(StandardTradingRuleInstrumentTradingHours),
...
class StandardTradingRuleInstrumentCodeEnum extends EnumClass {
  ...
  static const StandardTradingRuleInstrumentCodeEnum XUL10 =
      _$standardTradingRuleInstrumentCodeEnum_XUL10;
  @BuiltValueEnumConst(wireName: r'BCO10_BBJ')
  static const StandardTradingRuleInstrumentCodeEnum BCO10_BBJ =
      _$standardTradingRuleInstrumentCodeEnum_BCO10_BBJ;
  @BuiltValueEnumConst(wireName: r'HKK50_BBJ')
  static const StandardTradingRuleInstrumentCodeEnum HKK50_BBJ =
      _$standardTradingRuleInstrumentCodeEnum_HKK50_BBJ;
  @BuiltValueEnumConst(wireName: r'JPK50_BBJ')
  static const StandardTradingRuleInstrumentCodeEnum JPK50_BBJ =
      _$standardTradingRuleInstrumentCodeEnum_JPK50_BBJ;

  static Serializer<StandardTradingRuleInstrumentCodeEnum> get serializer =>
      _$standardTradingRuleInstrumentCodeEnumSerializer;

  const StandardTradingRuleInstrumentCodeEnum._(String name) : super(name);

  static BuiltSet<StandardTradingRuleInstrumentCodeEnum> get values =>
      _$standardTradingRuleInstrumentCodeEnumValues;
  static StandardTradingRuleInstrumentCodeEnum valueOf(String name) =>
      _$standardTradingRuleInstrumentCodeEnumValueOf(name);
}

class StandardTradingRuleInstrumentContractUnitEnum extends EnumClass {
  @BuiltValueEnumConst(wireName: r'troy ounce')
  static const StandardTradingRuleInstrumentContractUnitEnum troyOunce =
      _$standardTradingRuleInstrumentContractUnitEnum_troyOunce;
  @BuiltValueEnumConst(wireName: r'barrel')
  static const StandardTradingRuleInstrumentContractUnitEnum barrel =
      _$standardTradingRuleInstrumentContractUnitEnum_barrel;
  @BuiltValueEnumConst(wireName: r'USD/point')
  static const StandardTradingRuleInstrumentContractUnitEnum uSDSlashPoint =
      _$standardTradingRuleInstrumentContractUnitEnum_uSDSlashPoint;

  static Serializer<StandardTradingRuleInstrumentContractUnitEnum>
      get serializer =>
          _$standardTradingRuleInstrumentContractUnitEnumSerializer;

  const StandardTradingRuleInstrumentContractUnitEnum._(String name)
      : super(name);

  static BuiltSet<StandardTradingRuleInstrumentContractUnitEnum> get values =>
      _$standardTradingRuleInstrumentContractUnitEnumValues;
  static StandardTradingRuleInstrumentContractUnitEnum valueOf(String name) =>
      _$standardTradingRuleInstrumentContractUnitEnumValueOf(name);
}
