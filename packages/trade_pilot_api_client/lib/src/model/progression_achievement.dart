...
/// * [unlockedAt]
@BuiltValue()
abstract class ProgressionAchievement
    implements Built<ProgressionAchievement, ProgressionAchievementBuilder> {
  ...
  factory ProgressionAchievement(
          [void updates(ProgressionAchievementBuilder b)]) =
      _$ProgressionAchievement;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProgressionAchievementBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProgressionAchievement> get serializer =>
      _$ProgressionAchievementSerializer();
}

class _$ProgressionAchievementSerializer
    implements PrimitiveSerializer<ProgressionAchievement> {
  @override
