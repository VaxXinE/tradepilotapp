...
@BuiltValue()
abstract class AppleNativeLoginBody
    implements Built<AppleNativeLoginBody, AppleNativeLoginBodyBuilder> {
  ...
  factory AppleNativeLoginBody([void updates(AppleNativeLoginBodyBuilder b)]) =
      _$AppleNativeLoginBody;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AppleNativeLoginBodyBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AppleNativeLoginBody> get serializer =>
      _$AppleNativeLoginBodySerializer();
}

class _$AppleNativeLoginBodySerializer
    implements PrimitiveSerializer<AppleNativeLoginBody> {
  @override
