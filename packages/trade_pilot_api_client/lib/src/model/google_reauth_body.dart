...
@BuiltValue()
abstract class GoogleReauthBody
    implements Built<GoogleReauthBody, GoogleReauthBodyBuilder> {
  ...
  factory GoogleReauthBody([void updates(GoogleReauthBodyBuilder b)]) =
      _$GoogleReauthBody;
  ...
  static Serializer<GoogleReauthBody> get serializer =>
      _$GoogleReauthBodySerializer();
}

class _$GoogleReauthBodySerializer
    implements PrimitiveSerializer<GoogleReauthBody> {
  @override
