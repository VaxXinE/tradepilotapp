...
/// * [longestStreak]
@BuiltValue()
abstract class ProgressionSummary
    implements Built<ProgressionSummary, ProgressionSummaryBuilder> {
  ...
  factory ProgressionSummary([void updates(ProgressionSummaryBuilder b)]) =
      _$ProgressionSummary;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProgressionSummaryBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProgressionSummary> get serializer =>
      _$ProgressionSummarySerializer();
}

class _$ProgressionSummarySerializer
    implements PrimitiveSerializer<ProgressionSummary> {
  @override
