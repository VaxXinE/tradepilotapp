...
@BuiltValue()
abstract class StandardTradingRuleAccount
    implements
        Built<StandardTradingRuleAccount, StandardTradingRuleAccountBuilder> {
  ...
  factory StandardTradingRuleAccount(
          [void updates(StandardTradingRuleAccountBuilder b)]) =
      _$StandardTradingRuleAccount;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StandardTradingRuleAccountBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StandardTradingRuleAccount> get serializer =>
      _$StandardTradingRuleAccountSerializer();
}

class _$StandardTradingRuleAccountSerializer
    implements PrimitiveSerializer<StandardTradingRuleAccount> {
  @override
