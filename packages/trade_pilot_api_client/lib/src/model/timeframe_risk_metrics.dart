...
/// * [bollingerWidthPct]
@BuiltValue()
abstract class TimeframeRiskMetrics
    implements Built<TimeframeRiskMetrics, TimeframeRiskMetricsBuilder> {
  ...
  factory TimeframeRiskMetrics([void updates(TimeframeRiskMetricsBuilder b)]) =
      _$TimeframeRiskMetrics;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TimeframeRiskMetricsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TimeframeRiskMetrics> get serializer =>
      _$TimeframeRiskMetricsSerializer();
}

class _$TimeframeRiskMetricsSerializer
    implements PrimitiveSerializer<TimeframeRiskMetrics> {
  @override
