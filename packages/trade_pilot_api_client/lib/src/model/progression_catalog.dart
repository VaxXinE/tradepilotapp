...
/// * [achievements]
@BuiltValue()
abstract class ProgressionCatalog
    implements Built<ProgressionCatalog, ProgressionCatalogBuilder> {
  @BuiltValueField(wireName: r'achievements')
  BuiltList<ProgressionAchievement> get achievements;

  ProgressionCatalog._();

  factory ProgressionCatalog([void updates(ProgressionCatalogBuilder b)]) =
      _$ProgressionCatalog;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProgressionCatalogBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProgressionCatalog> get serializer =>
      _$ProgressionCatalogSerializer();
}

class _$ProgressionCatalogSerializer
    implements PrimitiveSerializer<ProgressionCatalog> {
  @override
