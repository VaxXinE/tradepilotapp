...
/// * [countryBreakdown]
@BuiltValue()
abstract class AnalyticsUsageStats
    implements Built<AnalyticsUsageStats, AnalyticsUsageStatsBuilder> {
  ...
  factory AnalyticsUsageStats([void updates(AnalyticsUsageStatsBuilder b)]) =
      _$AnalyticsUsageStats;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AnalyticsUsageStatsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AnalyticsUsageStats> get serializer =>
      _$AnalyticsUsageStatsSerializer();
}

class _$AnalyticsUsageStatsSerializer
    implements PrimitiveSerializer<AnalyticsUsageStats> {
  @override
      ...
      switch (key) {
        ...
        case r'featureBreakdown':
          final valueDes = serializers.deserialize(
            ...
            specifiedType: const FullType(BuiltList,
                [FullType(AnalyticsUsageStatsFeatureBreakdownInner)]),
        ...
        case r'browserBreakdown':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList,
                [FullType(AnalyticsUsageStatsBrowserBreakdownInner)]),
        ...
        case r'countryBreakdown':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList,
                [FullType(AnalyticsUsageStatsCountryBreakdownInner)]),
