...
/// * [entries]
@BuiltValue()
abstract class ProgressionHistory
    implements Built<ProgressionHistory, ProgressionHistoryBuilder> {
  @BuiltValueField(wireName: r'entries')
  BuiltList<ProgressionLedgerEntry> get entries;

  ProgressionHistory._();

  factory ProgressionHistory([void updates(ProgressionHistoryBuilder b)]) =
      _$ProgressionHistory;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProgressionHistoryBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProgressionHistory> get serializer =>
      _$ProgressionHistorySerializer();
}

class _$ProgressionHistorySerializer
    implements PrimitiveSerializer<ProgressionHistory> {
  @override
