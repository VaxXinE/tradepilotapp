...
@BuiltValue()
abstract class NativePushTestResult
    implements Built<NativePushTestResult, NativePushTestResultBuilder> {
  ...
  factory NativePushTestResult([void updates(NativePushTestResultBuilder b)]) =
      _$NativePushTestResult;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(NativePushTestResultBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<NativePushTestResult> get serializer =>
      _$NativePushTestResultSerializer();
}

class _$NativePushTestResultSerializer
    implements PrimitiveSerializer<NativePushTestResult> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      ...
      specifiedType: const FullType(
          BuiltList, [FullType(NativePushTestResultFailuresEnum)]),
    );
  }
...
class NativePushTestResultFailuresEnum extends EnumClass {
  ...
  static const NativePushTestResultFailuresEnum unregistered =
      _$nativePushTestResultFailuresEnum_unregistered;
  @BuiltValueEnumConst(wireName: r'auth')
  static const NativePushTestResultFailuresEnum auth =
      _$nativePushTestResultFailuresEnum_auth;
  @BuiltValueEnumConst(wireName: r'invalid')
  static const NativePushTestResultFailuresEnum invalid =
      _$nativePushTestResultFailuresEnum_invalid;
  @BuiltValueEnumConst(wireName: r'network')
  static const NativePushTestResultFailuresEnum network =
      _$nativePushTestResultFailuresEnum_network;

  static Serializer<NativePushTestResultFailuresEnum> get serializer =>
      _$nativePushTestResultFailuresEnumSerializer;

  const NativePushTestResultFailuresEnum._(String name) : super(name);

  static BuiltSet<NativePushTestResultFailuresEnum> get values =>
      _$nativePushTestResultFailuresEnumValues;
  static NativePushTestResultFailuresEnum valueOf(String name) =>
      _$nativePushTestResultFailuresEnumValueOf(name);
}
