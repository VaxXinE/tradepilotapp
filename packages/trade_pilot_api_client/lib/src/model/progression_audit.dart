...
/// * [entries]
@BuiltValue()
abstract class ProgressionAudit
    implements Built<ProgressionAudit, ProgressionAuditBuilder> {
  @BuiltValueField(wireName: r'entries')
  BuiltList<ProgressionAuditEntry> get entries;

  ProgressionAudit._();

  factory ProgressionAudit([void updates(ProgressionAuditBuilder b)]) =
      _$ProgressionAudit;
  ...
  static Serializer<ProgressionAudit> get serializer =>
      _$ProgressionAuditSerializer();
}

class _$ProgressionAuditSerializer
    implements PrimitiveSerializer<ProgressionAudit> {
  @override
