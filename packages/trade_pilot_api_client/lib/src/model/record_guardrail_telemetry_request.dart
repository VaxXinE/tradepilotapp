...
/// * [metadata]
@BuiltValue()
abstract class RecordGuardrailTelemetryRequest
    implements
        Built<RecordGuardrailTelemetryRequest,
  ...
  factory RecordGuardrailTelemetryRequest(
          [void updates(RecordGuardrailTelemetryRequestBuilder b)]) =
      _$RecordGuardrailTelemetryRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RecordGuardrailTelemetryRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RecordGuardrailTelemetryRequest> get serializer =>
      _$RecordGuardrailTelemetryRequestSerializer();
}

class _$RecordGuardrailTelemetryRequestSerializer
    implements PrimitiveSerializer<RecordGuardrailTelemetryRequest> {
  @override
