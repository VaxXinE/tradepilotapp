...
/// * [createdAt]
@BuiltValue()
abstract class ProgressionAuditEntry
    implements Built<ProgressionAuditEntry, ProgressionAuditEntryBuilder> {
  ...
  factory ProgressionAuditEntry(
      [void updates(ProgressionAuditEntryBuilder b)]) = _$ProgressionAuditEntry;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProgressionAuditEntryBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProgressionAuditEntry> get serializer =>
      _$ProgressionAuditEntrySerializer();
}

class _$ProgressionAuditEntrySerializer
    implements PrimitiveSerializer<ProgressionAuditEntry> {
  @override
  final Iterable<Type> types = const [
    ProgressionAuditEntry,
    _$ProgressionAuditEntry
  ];
