...
/// * [checklist]
@BuiltValue()
abstract class ProgressionEvidenceStartInput
    implements
        Built<ProgressionEvidenceStartInput,
            ProgressionEvidenceStartInputBuilder> {
  ...
  factory ProgressionEvidenceStartInput(
          [void updates(ProgressionEvidenceStartInputBuilder b)]) =
      _$ProgressionEvidenceStartInput;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProgressionEvidenceStartInputBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProgressionEvidenceStartInput> get serializer =>
      _$ProgressionEvidenceStartInputSerializer();
}

class _$ProgressionEvidenceStartInputSerializer
    implements PrimitiveSerializer<ProgressionEvidenceStartInput> {
  @override
      ...
      switch (key) {
        case r'source':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(ProgressionEvidenceStartInputSource_Enum),
        ...
        case r'checklist':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType.nullable(ProgressionEvidenceStartInputChecklist),
...
class ProgressionEvidenceStartInputSource_Enum extends EnumClass {
  ...
  static const ProgressionEvidenceStartInputSource_Enum preAnalysisChecklist =
      _$progressionEvidenceStartInputSourceEnum_preAnalysisChecklist;
  @BuiltValueEnumConst(wireName: r'guide_completion')
  static const ProgressionEvidenceStartInputSource_Enum guideCompletion =
      _$progressionEvidenceStartInputSourceEnum_guideCompletion;

  static Serializer<ProgressionEvidenceStartInputSource_Enum> get serializer =>
      _$progressionEvidenceStartInputSourceEnumSerializer;

  const ProgressionEvidenceStartInputSource_Enum._(String name) : super(name);

  static BuiltSet<ProgressionEvidenceStartInputSource_Enum> get values =>
      _$progressionEvidenceStartInputSourceEnumValues;
  static ProgressionEvidenceStartInputSource_Enum valueOf(String name) =>
      _$progressionEvidenceStartInputSourceEnumValueOf(name);
}

class ProgressionEvidenceStartInputGuideIdEnum extends EnumClass {
  @BuiltValueEnumConst(wireName: r'how-ai-works')
  static const ProgressionEvidenceStartInputGuideIdEnum howAiWorks =
      _$progressionEvidenceStartInputGuideIdEnum_howAiWorks;
  @BuiltValueEnumConst(wireName: r'feature-map')
  static const ProgressionEvidenceStartInputGuideIdEnum featureMap =
      _$progressionEvidenceStartInputGuideIdEnum_featureMap;
  @BuiltValueEnumConst(wireName: r'reading-analysis')
  static const ProgressionEvidenceStartInputGuideIdEnum readingAnalysis =
      _$progressionEvidenceStartInputGuideIdEnum_readingAnalysis;
  @BuiltValueEnumConst(wireName: r'validity-confidence')
  static const ProgressionEvidenceStartInputGuideIdEnum validityConfidence =
      _$progressionEvidenceStartInputGuideIdEnum_validityConfidence;
  @BuiltValueEnumConst(wireName: r'adaptive-plan')
  static const ProgressionEvidenceStartInputGuideIdEnum adaptivePlan =
      _$progressionEvidenceStartInputGuideIdEnum_adaptivePlan;
  @BuiltValueEnumConst(wireName: r'personal-progression')
  static const ProgressionEvidenceStartInputGuideIdEnum personalProgression =
      _$progressionEvidenceStartInputGuideIdEnum_personalProgression;
  @BuiltValueEnumConst(wireName: r'analysis-workflow')
  static const ProgressionEvidenceStartInputGuideIdEnum analysisWorkflow =
      _$progressionEvidenceStartInputGuideIdEnum_analysisWorkflow;
  @BuiltValueEnumConst(wireName: r'bias-confidence-validity')
  static const ProgressionEvidenceStartInputGuideIdEnum biasConfidenceValidity =
      _$progressionEvidenceStartInputGuideIdEnum_biasConfidenceValidity;
  @BuiltValueEnumConst(wireName: r'levels-chart')
  static const ProgressionEvidenceStartInputGuideIdEnum levelsChart =
      _$progressionEvidenceStartInputGuideIdEnum_levelsChart;
  @BuiltValueEnumConst(wireName: r'timeframe-risk-map')
  static const ProgressionEvidenceStartInputGuideIdEnum timeframeRiskMap =
      _$progressionEvidenceStartInputGuideIdEnum_timeframeRiskMap;
  @BuiltValueEnumConst(wireName: r'technical-fundamental')
  static const ProgressionEvidenceStartInputGuideIdEnum technicalFundamental =
      _$progressionEvidenceStartInputGuideIdEnum_technicalFundamental;
  @BuiltValueEnumConst(wireName: r'standard-plan')
  static const ProgressionEvidenceStartInputGuideIdEnum standardPlan =
      _$progressionEvidenceStartInputGuideIdEnum_standardPlan;
  @BuiltValueEnumConst(wireName: r'adaptive-position-plan')
  static const ProgressionEvidenceStartInputGuideIdEnum adaptivePositionPlan =
      _$progressionEvidenceStartInputGuideIdEnum_adaptivePositionPlan;
  @BuiltValueEnumConst(wireName: r'account-rules')
  static const ProgressionEvidenceStartInputGuideIdEnum accountRules =
      _$progressionEvidenceStartInputGuideIdEnum_accountRules;
  @BuiltValueEnumConst(wireName: r'terms')
  static const ProgressionEvidenceStartInputGuideIdEnum terms =
      _$progressionEvidenceStartInputGuideIdEnum_terms;

  static Serializer<ProgressionEvidenceStartInputGuideIdEnum> get serializer =>
      _$progressionEvidenceStartInputGuideIdEnumSerializer;

  const ProgressionEvidenceStartInputGuideIdEnum._(String name) : super(name);

  static BuiltSet<ProgressionEvidenceStartInputGuideIdEnum> get values =>
      _$progressionEvidenceStartInputGuideIdEnumValues;
  static ProgressionEvidenceStartInputGuideIdEnum valueOf(String name) =>
      _$progressionEvidenceStartInputGuideIdEnumValueOf(name);
}
