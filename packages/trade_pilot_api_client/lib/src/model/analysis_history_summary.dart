...
/// * [byTimeframe]
@BuiltValue()
abstract class AnalysisHistorySummary
    implements Built<AnalysisHistorySummary, AnalysisHistorySummaryBuilder> {
  ...
  factory AnalysisHistorySummary(
          [void updates(AnalysisHistorySummaryBuilder b)]) =
      _$AnalysisHistorySummary;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AnalysisHistorySummaryBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AnalysisHistorySummary> get serializer =>
      _$AnalysisHistorySummarySerializer();
}

class _$AnalysisHistorySummarySerializer
    implements PrimitiveSerializer<AnalysisHistorySummary> {
  @override
      ...
      switch (key) {
        ...
        case r'byInstrument':
          final valueDes = serializers.deserialize(
            ...
            specifiedType: const FullType(
                BuiltList, [FullType(AnalysisHistoryInstrumentStats)]),
        ...
        case r'byTimeframe':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(
                BuiltList, [FullType(AnalysisHistoryTimeframeStats)]),
...
class AnalysisHistorySummaryRangeEnum extends EnumClass {
  ...
  static const AnalysisHistorySummaryRangeEnum n7 =
      _$analysisHistorySummaryRangeEnum_n7;
  @BuiltValueEnumConst(wireName: r'30')
  static const AnalysisHistorySummaryRangeEnum n30 =
      _$analysisHistorySummaryRangeEnum_n30;
  @BuiltValueEnumConst(wireName: r'90')
  static const AnalysisHistorySummaryRangeEnum n90 =
      _$analysisHistorySummaryRangeEnum_n90;
  @BuiltValueEnumConst(wireName: r'all')
  static const AnalysisHistorySummaryRangeEnum all =
      _$analysisHistorySummaryRangeEnum_all;

  static Serializer<AnalysisHistorySummaryRangeEnum> get serializer =>
      _$analysisHistorySummaryRangeEnumSerializer;

  const AnalysisHistorySummaryRangeEnum._(String name) : super(name);

  static BuiltSet<AnalysisHistorySummaryRangeEnum> get values =>
      _$analysisHistorySummaryRangeEnumValues;
  static AnalysisHistorySummaryRangeEnum valueOf(String name) =>
      _$analysisHistorySummaryRangeEnumValueOf(name);
}
