...
/// * [label]
@BuiltValue()
abstract class StandardTradingRulesFixedRate
    implements
        Built<StandardTradingRulesFixedRate,
  ...
  factory StandardTradingRulesFixedRate(
          [void updates(StandardTradingRulesFixedRateBuilder b)]) =
      _$StandardTradingRulesFixedRate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StandardTradingRulesFixedRateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StandardTradingRulesFixedRate> get serializer =>
      _$StandardTradingRulesFixedRateSerializer();
}

class _$StandardTradingRulesFixedRateSerializer
    implements PrimitiveSerializer<StandardTradingRulesFixedRate> {
  @override
