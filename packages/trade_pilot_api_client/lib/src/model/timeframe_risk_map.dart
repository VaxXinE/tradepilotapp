...
/// * [overall]
@BuiltValue()
abstract class TimeframeRiskMap
    implements Built<TimeframeRiskMap, TimeframeRiskMapBuilder> {
  ...
  factory TimeframeRiskMap([void updates(TimeframeRiskMapBuilder b)]) =
      _$TimeframeRiskMap;
  ...
  static Serializer<TimeframeRiskMap> get serializer =>
      _$TimeframeRiskMapSerializer();
}

class _$TimeframeRiskMapSerializer
    implements PrimitiveSerializer<TimeframeRiskMap> {
  @override
