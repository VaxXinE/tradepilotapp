...
/// * [reason]
@BuiltValue()
abstract class ProgressionAward
    implements Built<ProgressionAward, ProgressionAwardBuilder> {
  ...
  factory ProgressionAward([void updates(ProgressionAwardBuilder b)]) =
      _$ProgressionAward;
  ...
  static Serializer<ProgressionAward> get serializer =>
      _$ProgressionAwardSerializer();
}

class _$ProgressionAwardSerializer
    implements PrimitiveSerializer<ProgressionAward> {
  @override
