...
@BuiltValue()
abstract class StandardTradingRules
    implements Built<StandardTradingRules, StandardTradingRulesBuilder> {
  ...
  factory StandardTradingRules([void updates(StandardTradingRulesBuilder b)]) =
      _$StandardTradingRules;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StandardTradingRulesBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StandardTradingRules> get serializer =>
      _$StandardTradingRulesSerializer();
}

class _$StandardTradingRulesSerializer
    implements PrimitiveSerializer<StandardTradingRules> {
  @override
        ...
        case r'instruments':
          final valueDes = serializers.deserialize(
            ...
            specifiedType: const FullType(
                BuiltList, [FullType(StandardTradingRuleInstrument)]),
